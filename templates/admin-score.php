...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-4">
      <div class="card">
        <h3 class="card-header">Daftar Quiz</h3>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button onclick="executeDelete();" type="button" data-dismiss="modal" class="btn btn-danger">Hapus</button>
      </div>
    </div>
  </div>
</div>

<script src="<?=BASE_URL?>/js/admin-score.js" defer="defer"></script>
